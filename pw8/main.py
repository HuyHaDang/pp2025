...
from input import save_data_async
students_list = []
...
#   courses_list.append(  Course("java", "java", 3))
  load_data(students_list, courses_list, marks_dict)
  ...
  while True:
        ...
        match choice:
          ...
          #  case 7: showGPA()
           ...
           case 0:
             save_data_async(students_list, courses_list, marks_dict)
             break
